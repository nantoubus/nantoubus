...
{
    public class StopArrivalPredictionView : StackLayout
    {
        ...
        public StopArrivalPredictionView(StopOfRoute stopsOfSingleRoute, IEnumerable<RoutePrediction> predictions) : base()
        {
            Spacing = 3;
